    ...
    <div className="flex min-h-screen bg-[#151929]">
      ...
      <div className="w-16 border-r border-gray-700 flex flex-col items-center py-8">
        ...
        <div className="flex flex-col items-center space-y-8">
          <Link href="/admin/dashboard" className="text-white p-2 rounded hover:bg-[#7c68ee33]">
          ...
          <Link href="/admin/notifications" className="text-white p-2 rounded hover:bg-[#7c68ee33] relative">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="/admin/chat" className="text-white p-2 rounded hover:bg-[#7c68ee33]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z" />
            </svg>
          </Link>
          
          <Link href="/admin/users" className="text-white p-2 rounded hover:bg-[#7c68ee33]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
