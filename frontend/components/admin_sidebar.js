...
export default function Sidebar() {
  return (
    <div className="w-[80px] bg-[#1F1D38] flex flex-col items-center pt-6 pb-4 min-h-screen rounded-2xl shadow-lg">
      ...
      <div className="flex flex-col items-center space-y-6 flex-grow">
        ...
        {/* Dashboard */}
        <Link href="/admin">
          <div className="p-3 bg-[#18172E] rounded-lg hover:bg-[#25243A] transition">
        ...
        {/* Notifications */}
        <Link href="/admin/projects?filter=pending" className="relative p-3 hover:bg-[#25243A] rounded-lg transition">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link href="/admin/messages">
          <div className="p-3 hover:bg-[#25243A] rounded-lg transition">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="mt-auto">
        <Link href="/logout">
          <div className="p-3 hover:bg-[#3A1D1D] rounded-lg transition">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
